    ...
    constructor(props) {
        ...
        this.state = {
            breadcrumbItems : [
                ...
                { title : "Add Student Profile", link : "#" },
            ],
            customchk: true,
            toggleSwitch: true,
            ue: null,
    ...
    handleSubmit(event, values) {
        ...
        .then(response => {
            ...
            if(response.data===201){
                ...
                this.props.history.replace('/addStudent');
            }else{
            ...
            <React.Fragment>
                <div className="page-content">
                    <Container fluid>
                        ...
                        <Breadcrumbs title="Add Student Profile" breadcrumbItems={this.state.breadcrumbItems} />
                        ...
                        <Row>
                            ...
                            <Col lg={12}>
                                <Card>
                                    <CardBody>
                                        <h4 className="card-title">Add Student Profile</h4>
...
export default withRouter(StudentAddPage) ;
